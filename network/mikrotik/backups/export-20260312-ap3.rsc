# 2026-03-12 15:04:04 by RouterOS 7.19.6
...
add band=2ghz-g/n comment="2.4GHz Channel 6" frequency=2437 name=ch-2ghz-ch6
/interface bridge
...
add channel=ch-2ghz comment="Legacy IoT - 2.4GHz Downstairs" country=\
    ...
    security=sec-iot-2g ssid=COLLECTIVE-2G
add channel=ch-2ghz-ch6 comment="Trusted - 2.4GHz Bedroom" country=\
    "united states" datapath=datapath-trusted name=cfg-collective-2ghz-bed \
    security=sec-trusted ssid=COLLECTIVE
add channel=ch-2ghz-ch6 comment="IoT - 2.4GHz Bedroom" country=\
    "united states" datapath=datapath-iot name=cfg-collective-iot-2ghz-bed \
    security=sec-iot ssid=COLLECTIVE-IOT
add channel=ch-2ghz-ch6 comment="Guest - 2.4GHz Bedroom" country=\
    "united states" datapath=datapath-guest name=\
    cfg-collective-guest-2ghz-bed security=sec-guest ssid=COLLECTIVE-GUEST
add channel=ch-2ghz-ch6 comment="Legacy IoT - 2.4GHz Bedroom" country=\
    "united states" datapath=datapath-iot name=cfg-collective-2g-bed \
    security=sec-iot-2g ssid=COLLECTIVE-2G
/interface list
...
add action=create-dynamic-enabled comment="Bedroom 2.4GHz - Ch 6" \
    master-configuration=cfg-collective-2ghz-bed radio-mac=18:FD:74:5C:C6:8C \
    slave-configurations="cfg-collective-iot-2ghz-bed,cfg-collective-guest-2gh\
    z-bed,cfg-collective-2g-bed"
/disk settings
...
add address=10.0.40.50 comment="SHOWFINDER - torrent laptop" mac-address=\
    3C:55:76:54:87:DD server=dhcp-iot
...
add action=accept chain=forward comment="Allow SHOWFINDER to NAS (SMB)" \
    dst-address=10.0.30.10 dst-port=445 protocol=tcp src-address=10.0.40.50
add action=accept chain=forward comment=\
    "Allow Chromecast Audio to NAS (Plex)" dst-address=10.0.30.10 dst-port=\
    32400 protocol=tcp src-address=10.0.40.185
